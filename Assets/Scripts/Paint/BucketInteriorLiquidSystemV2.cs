...
public class BucketInteriorLiquidSystemV2 : MonoBehaviour
{
    ...
    [Range(32, 224)] public int radialSegments = 144;
    [Range(8, 72)] public int radialRings = 40;
    [Range(2, 28)] public int sideVerticalSubdivisions = 16;
    [Range(0, 64)] public int rimHighlightCount = 36;
    ...
    private void LateUpdate()
    {
        ...
        if (forceRebuildRequested || topologyChanged || rebuildTimer >= 0.022f)
        {
