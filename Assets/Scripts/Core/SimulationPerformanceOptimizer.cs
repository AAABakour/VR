...
public class SimulationPerformanceOptimizer : MonoBehaviour
{
    ...
    public PerformanceMode startupMode = PerformanceMode.FinalBalanced;
    ...
    [SerializeField] private PerformanceMode currentMode = PerformanceMode.FinalBalanced;
    ...
    private string BuildSummary()
    {
        ...
        return currentMode + " | particles " + particles + " | film " + film + " | bucket " + bucket + " | rope " + rope;
    }
