...
public class SimulationPresetApplier : MonoBehaviour
{
    ...
    private void ApplyCleanSpiralPreset()
    {
        ...
        if (paintEmitter != null)
        {
            paintEmitter.paintColor = new Color(0.55f, 0.006f, 0.002f, 0.96f);
            ...
            paintEmitter.particlesPerUnitFlow = 30f;
            paintEmitter.randomSpread = 0.035f;
        ...
        if (particleSimulator != null)
        {
            particleSimulator.maxParticles = 650;
        ...
        if (canvasPainter != null)
        {
            ...
            canvasPainter.sprayAmount = 0.12f;
    ...
    private void ApplySplashyPaintPreset()
    {
        ...
        if (paintEmitter != null)
        {
            ...
            paintEmitter.particlesPerUnitFlow = 34f;
            paintEmitter.randomSpread = 0.055f;
        ...
        if (particleSimulator != null)
        {
            particleSimulator.maxParticles = 700;
            ...
            particleSimulator.windStrength = 0.04f;
            particleSimulator.turbulenceStrength = 0.06f;
        ...
        if (canvasPainter != null)
        {
            ...
            canvasPainter.sprayAmount = 0.18f;
            canvasPainter.smearLength = 1.2f;
            canvasPainter.smearSteps = 5;
            canvasPainter.edgeIrregularity = 0.28f;
        }
        ApplyImpactSurfaceProfile(canvasProfile);
    }
    ...
    private void ApplyDenseFlowPreset()
    {
        ...
        if (paintEmitter != null)
        {
            ...
            paintEmitter.particlesPerUnitFlow = 36f;
            paintEmitter.randomSpread = 0.040f;
        ...
        if (particleSimulator != null)
        {
            particleSimulator.maxParticles = 720;
            ...
            particleSimulator.turbulenceStrength = 0.05f;
        ...
        if (canvasPainter != null)
        {
            ...
            canvasPainter.paintOpacity = 0.9f;
            canvasPainter.sprayAmount = 0.16f;
            canvasPainter.smearLength = 0.75f;
            canvasPainter.smearSteps = 4;
            canvasPainter.edgeIrregularity = 0.30f;
        }
    ...
    private void ApplyDoubleHolePatternPreset()
    {
        ...
        if (paintEmitter != null)
        {
            ...
            paintEmitter.particlesPerUnitFlow = 32f;
            paintEmitter.randomSpread = 0.045f;
        ...
        if (canvasPainter != null)
        {
            ...
            canvasPainter.smearSteps = 5;
            canvasPainter.edgeIrregularity = 0.26f;
        }
        ApplyImpactSurfaceProfile(canvasProfile);
    }
    ...
    private void ApplyMetalSpreadPreset()
    {
        ...
        if (paintEmitter != null)
        {
            ...
            paintEmitter.particlesPerUnitFlow = 34f;
            paintEmitter.randomSpread = 0.050f;
        ...
        if (canvasPainter != null)
        {
            ...
            canvasPainter.sprayAmount = 0.20f;
            canvasPainter.smearLength = 1.8f;
            canvasPainter.smearSteps = 6;
            canvasPainter.edgeIrregularity = 0.22f;
        }
    ...
    private void ApplyPerformanceSafetyAfterPreset()
    {
        if (paintEmitter != null)
        {
            ...
            paintEmitter.maxParticlesEmittedPerFrame = Mathf.Clamp(paintEmitter.maxParticlesEmittedPerFrame, 16, 72);
            paintEmitter.maxEmissionBacklog = Mathf.Clamp(paintEmitter.maxEmissionBacklog, 0f, 36f);
        }

        if (particleSimulator != null)
        {
            particleSimulator.maxParticles = Mathf.Clamp(particleSimulator.maxParticles, 100, 760);
            ...
            particleSimulator.maxInteractionChecks = Mathf.Clamp(particleSimulator.maxInteractionChecks, 0, 10);
